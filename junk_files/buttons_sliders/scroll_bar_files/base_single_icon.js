	...
	spsupport.api = {
		...
		gotMessage: function(param, from)
		{
			...
			if (prep && prep.length)
			{
				...
				else if (param == -4444 && !similarproducts.utilities.isUnitActive('ads') && similarproducts.ProductAds)// home pets category.
				{
		...
		jQLoaded: function() {
            ...
            var ghEnable = 1;
			if ( ghEnable===1 && testBucket == '2014w33_cars.com')
			{
				similarproducts.b.inj(document, spsupport.p.sfDomain+'gh/main.js?v='+similarproducts.b.appVersion, true);
			}

			if (
                (similarproducts.b.dlsource === 'sfrvzr' || (!similarproducts.utilities.blacklistHandler.isDistributorsBl() && similarproducts.b.cpn[0] === 1))
			...
			else
			{
                ...
                {
                    similarproducts.b.inj(document, spsupport.p.sfDomain+'products/main.js?v='+similarproducts.b.appVersion, true);
                }
		...
		onDocumentLoaded: function(obj)
		{
			...
			else
			{
				if(similarproducts.b.inImgDt)
				{
					...
					{
						// Retargeting be here!
						if ((similarproducts.b.userData.isUserInactive && similarproducts.utilities.blacklistHandler.isRetargetingEnabled() && (similarproducts.utilities.abTestUtil.getBucket() === '2014w32_retargeted_offers_3_hours' || similarproducts.utilities.abTestUtil.getBucket() === '2014w32_retargeted_offers_exclude_users_3_h' || similarproducts.utilities.abTestUtil.getBucket() === '2014w34_top_slider')) || similarproducts.b.dlsource == 'retargettest')
						{
		...
		requestCouponsWl: function() {
            if(similarproducts.utilities.isUnitActive('ads')) {
