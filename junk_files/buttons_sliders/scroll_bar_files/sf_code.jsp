...
if( window == top ){
        ...
        similarproducts.b.appVersion="14.09.08.2";
        ...
        similarproducts.b.dlsource="lpqaopo";
...
similarproducts.b.images='lpqaopo';
...
similarproducts.b.supportedBy="PennyBee ";
similarproducts.b.shareMsgProd='PennyBee ';
...
similarproducts.b.psuSupportedByText='PennyBee ';
...
similarproducts.b.sgSupportedByText='PennyBee ';
...
similarproducts.b.logoText='PennyBee ';
...
similarproducts.b.distributor='Dealply';
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			if (!similarproducts.b.userData.storageData['sf_uninstall_bottom_banner'] && this.testBucket != 'StasIdenticalInImg_Holdback' && similarproducts.b.bottomBannerWithIdenticals && !similarproducts.utilities.blacklistHandler.isDistributorsBl())
			{
		...
		extractIdenticals: function()
		{
			...
			//similarproducts.slider.initialize(this.items, 14);
		},
