        ...
        <div class="share_com" id="comment-form">
            <div id="form_prev_holder">
                <div id="form-holder">
                    ...
                    <div class="but-wrap"><a href="#" class="button go_button" title="<?php _e( 'Add comment', LANGUAGE_ZONE ); ?>"><span><i class="submit"></i><?php _e( 'Submit comment', LANGUAGE_ZONE ); ?></span></a></div>
                    <span class="c-clear"><a href="#" class="do-clear"><?php _e( 'clear form', LANGUAGE_ZONE ); ?></a></span>
