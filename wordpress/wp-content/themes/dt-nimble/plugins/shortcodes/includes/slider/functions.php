...
function dt_shortcode_anything_slider( $atts, $content = null ) {
    ...
    $sizes_full = array(
       'one-fourth'    => array( 210 ),
       'three-fourth'  => array( 710 ),
        'one-third'     => array( 294 ),
        'two-thirds'    => array( 628 ),
        'half'          => array( 460 ),
        'full-width'    => array( 960 )
    );

    $sizes = array(
        'one-fourth'    => array( 148 ),
        'three-fourth'  => array( 524 ),
        'one-third'     => array( 210 ),
        'two-thirds'    => array( 460 ),
        'half'          => array( 336 ),
        'full-width'    => array( 710 )
    );
    ...
    $slider = dt_get_anything_slider( array(
        ...
        'class'     => 'slider-shortcode flexslider',
