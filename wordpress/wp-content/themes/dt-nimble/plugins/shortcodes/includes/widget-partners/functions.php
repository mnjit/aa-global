...
add_shortcode( 'dt_partners', 'dt_shortcode_widget_logo' );
function dt_shortcode_widget_logo( $atts ) {
    extract(
        shortcode_atts(
            array(
                'title'     => '',
...
add_action( 'wp_ajax_dt_ajax_editor_widget_logo', 'dt_shortcode_widget_logo_ajax_editor' );
function dt_shortcode_widget_logo_ajax_editor() {
