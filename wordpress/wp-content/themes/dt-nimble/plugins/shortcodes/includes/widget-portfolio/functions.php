...
function dt_print_widget_portfolio( $atts ) {
    ...
    $img_sizes_full = array(
        'one-fourth'    => array( 210, 130 ),
        'three-fourth'  => array( 223, 140 ),
        'one-third'     => array( 290, 180 ),
        'two-thirds'    => array( 303, 190 ),
        'half'          => array( 219, 140 ),
        'full-width'    => array( 225, 140 )
    );

    $img_sizes = array(
        'one-fourth'    => array( 147, 90 ),
        'three-fourth'  => array( 158, 100 ),
        'one-third'     => array( 209, 130 ),
        'two-thirds'    => array( 220, 140 ),
        'half'          => array( 157, 100 ),
        'full-width'    => array( 162, 100 )
    );
...
function dt_ajax_editor_widget_portfolio() {
	...
	<fieldset style="padding-left: 15px;">
        ...
        <input type="text" value="" name="thumb_height" id="dt_thumb_height" />
    </fieldset>
