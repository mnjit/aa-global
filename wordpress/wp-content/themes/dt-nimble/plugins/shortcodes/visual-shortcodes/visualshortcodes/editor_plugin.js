...
*/            });
        ...
        _doScImage: function( co ){
            ...
            return co.replace( t.regex, function(a,b,c){
				...
				new_class = new_class.replace(/_/g, '');
                ...
                return '<p class="helper-tag"><img src="'+t.shortcodes[b].image+'" id="vscImage'+(t.counter++)+'-'+b+'" class="mceItem jpbVisualShortcode ' + new_class + '" data-mce-shortcode="' + b + tinymce.DOM.encode(c) + '" /></p>';
            });
        },
        ...
        _getScImage: function( co ){
            ...
            return co.replace(/(?:<p[^>]*>)*(<img[^>]+>)(?:<\/p>)*/g, function(a,im) {
                ...
                if ( cls.indexOf('jpbVisualShortcode') != -1 )
                    return '<p>['+tinymce.trim(getAttr(im, 'data-mce-shortcode'))+']</p>';
