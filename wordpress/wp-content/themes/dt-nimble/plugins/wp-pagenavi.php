 ...
 */      
		...
		if($max_page > 1 || intval($opts['always_show']) == 1) {
            ...
            if( $opts['total_pages'] ) {
                ...
                if( !$pages_next )
                    $pages_next = '<a href="#" class="next no-act" onclick="return false;"><span class="a-l-s">&#8250;</span><span class="a-r-s">&#8250;</span></a>';

                if( !$pages_prev )
                    $pages_prev = '<a href="#" class="prev no-act" onclick="return false;"><span class="a-l-s">&#8249;</span><span class="a-r-s">&#8249;</span></a>';
